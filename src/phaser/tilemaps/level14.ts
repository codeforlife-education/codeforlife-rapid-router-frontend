    ...
    objectGroup: {
      ...
      scenery: {
        objects: [
          ...
          layers.objectGroup.objects.scenery.nature.bush({ x: 319, y: 322 }),
          layers.objectGroup.objects.scenery.nature.tree.oak({ x: 493, y: 24 }),
          layers.objectGroup.objects.scenery.nature.tree.oak({ x: 554, y: 92 }),
