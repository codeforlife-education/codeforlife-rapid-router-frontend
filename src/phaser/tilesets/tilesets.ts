...
export const IDs = createIdRegistry({
  ...
  31: scenery({ Nature: "BUSH" }),
  32: scenery({ Nature: "CROPS" }),
  33: scenery({ Nature: "HAY" }),
  34: scenery({ Nature: "POND" }),
  35: scenery({ Nature: { Tree: "OAK" } }),
  36: scenery({ Nature: { Tree: "PINE" } }),
  37: scenery({ Other: "SOLAR_PANEL" }),
